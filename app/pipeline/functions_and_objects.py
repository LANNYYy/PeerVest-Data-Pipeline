...
columns_list3 = ['loan_amnt', 'funded_amnt',
                'term', 'int_rate',
                ...
                'total_il_high_credit_limit','grade',
                'sub_grade',
                'emp_title']
...
nan_zero_cols = [
    ...
    'open_rv_24m', 'inq_fi', 'inq_last_12m', 'num_accts_ever_120_pd',
    'num_actv_bc_tl', 'num_actv_rev_tl', 'num_bc_sats', 'num_bc_tl',
    'num_il_tl', 'num_op_rev_tl', 'num_rev_accts', 'num_rev_tl_bal_gt_0',
    'num_sats', 'num_tl_120dpd_2m', 'num_tl_30dpd', 'num_tl_90g_dpd_24m',
    'num_tl_op_past_12m', 'mort_acc', 'percent_bc_gt_75', 'tot_hi_cred_lim',
    'total_bal_ex_mort', 'total_bc_limit', 'total_il_high_credit_limit',
    'bc_open_to_buy', 'acc_open_past_24mths', 'total_cu_tl', 'total_rev_hi_lim',
    'emp_length', 'pub_rec_bankruptcies', 'tax_liens'
]

nan_mean_cols = [
    'dti', 'annual_inc_joint', 'dti_joint', 'il_util', 'all_util',
    'bc_util', 'pct_tl_nvr_dlq', 'avg_cur_bal', 'revol_util'
]
...
def clean_LC_data_classification_eval(dfs_list):
    '''Prepare completed loan term LendingClub data for classification.
    ...
    clean_lc_df = lc_df.dropna(subset=['collections_12_mths_ex_med','chargeoff_within_12_mths','last_pymnt_d'],axis=0)
    return clean_lc_df
...
def clean_new_LC_data_classification_current(dfs_list):
    ...
    lc_df.loc[lc_df['emp_title'].isin(idx) == False, 'emp_title_2'] = lc_df['emp_title']
    lc_df.loc[lc_df['emp_title'].isin(idx), 'emp_title_2'] = 'Other'
    clean_lc_df_current = lc_df.dropna(subset=['collections_12_mths_ex_med','chargeoff_within_12_mths'],axis=0)
...
def one_hot_encode_eval(X_train, X_test):
    ...
    return (ohe_home_ownership, ohe_purpose, ohe_sub_grade, ohe_emp_title_2,
            ohe_home_ownership_test, ohe_purpose_test, ohe_sub_grade_test, ohe_emp_title_2_test)
